...
function create_cartpole!(vis)
	mc.setobject!(vis[:cart], mc.HyperRectangle(mc.Vec(-0.25, -1.0, -0.15), mc.Vec(0.5, 2, 0.3)))
	mc.setobject!(vis[:pole], mc.Cylinder(mc.Point(0, 0, -0.75), mc.Point(0, 0, 0.75), 0.05))
